...
class Version20170407171423 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE vehicle ADD CONSTRAINT FK_1F1B251E1C52F958 FOREIGN KEY (brand) REFERENCES brand (id)');
        $this->addSql('ALTER TABLE vehicle ADD CONSTRAINT FK_1F1B251ED79572D9 FOREIGN KEY (model) REFERENCES model (id)');
        $this->addSql('ALTER TABLE vehicle ADD CONSTRAINT FK_1F1B251E5373C966 FOREIGN KEY (country) REFERENCES country (id)');
        $this->addSql('ALTER TABLE vehicle ADD CONSTRAINT FK_1F1B251E2D5B0234 FOREIGN KEY (city) REFERENCES city (id)');
        $this->addSql('ALTER TABLE vehicle ADD CONSTRAINT FK_1F1B251ED95AEB4B FOREIGN KEY (body_type) REFERENCES body_type (id)');
        $this->addSql('ALTER TABLE vehicle ADD CONSTRAINT FK_1F1B251E9CA10F38 FOREIGN KEY (fuel_type) REFERENCES fuel_type (id)');
        $this->addSql('ALTER TABLE vehicle ADD CONSTRAINT FK_1F1B251E665648E9 FOREIGN KEY (color) REFERENCES color (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE vehicle DROP FOREIGN KEY FK_1F1B251ED95AEB4B');
        $this->addSql('ALTER TABLE vehicle DROP FOREIGN KEY FK_1F1B251E665648E9');
        $this->addSql('ALTER TABLE vehicle DROP FOREIGN KEY FK_1F1B251E2D5B0234');
        $this->addSql('ALTER TABLE vehicle DROP FOREIGN KEY FK_1F1B251E1C52F958');
        $this->addSql('ALTER TABLE model DROP FOREIGN KEY FK_D79572D91C52F958');
        $this->addSql('ALTER TABLE vehicle DROP FOREIGN KEY FK_1F1B251E5373C966');
        $this->addSql('ALTER TABLE vehicle DROP FOREIGN KEY FK_1F1B251E9CA10F38');
        $this->addSql('ALTER TABLE vehicle DROP FOREIGN KEY FK_1F1B251ED79572D9');
